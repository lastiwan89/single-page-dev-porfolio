      ...
      <div className="hero">
        <div className="flex flex-col items-center pb-16 md:items-stretch">
          ...
          <div className="z-10 mt-8 flex flex-col gap-5 md:mt-28 md:w-[500px] md:gap-0 md:pl-6 lg:w-[700px] lg:pl-16 xl:pl-28">
            <h1 className="text-white-lighter text-center text-fs-40 font-bold leading-lh-40 -tracking-ls-1.136 md:text-start md:text-fs-72 md:leading-lh-72 md:-tracking-ls-2.045">
              Nice to <br className="hidden md:block" /> meet you! I’m{" "}
              <span className="border-b-4 border-green">Adam Keyes</span>.
            </h1>
            <p className="text-white-lighter text-center text-fs-16 leading-lh-26 md:mt-16 md:text-start md:text-fs-18 md:leading-lh-28">
